...
@pauth.route('/login')
def login():
    return google.authorize(callback=url_for('pauth.authorized', _external=True))

@pauth.route('/login/authorized')
def authorized():
...
app.register_blueprint(pauth, url_prefix='/pauth')
